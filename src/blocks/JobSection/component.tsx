import { type JobSectionProps, type JobProps, type GradientOptions } from '@/types/blockTypes'
...
const JobSection: React.FC<JobSectionProps> = ({
  ...
  return (
    ...
    >
      {gradient && (
        <div className="z-0 absolute top-1/6 right-0 md:right-8 rounded-full h-56 sm:h-[10rem] md:h-[20rem] w-[45rem] overflow-hidden blur-3xl sm:opacity-70">
