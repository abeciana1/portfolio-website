...
import { type ProblemFramingSectionBlockProps, type GradientOptions } from '@/types/blockTypes'
    ...
    >
      <section className="relative flex flex-col gap-6 z-40 text-center md:max-w-2xl mx-auto">
        ...
        <div
          ...
          data-testid="problem-desc"
          className="text-darkGrey dark:text-pillGrey text-xl font-semibold"
        >
          {description}
        </div>
      </section>
      <section className="relative grid grid-cols-1 md:grid-cols-2 gap-6 px-5 lg:px-20 lg:max-w-[1000px] mx-auto">
        {gradient && (
          <div className="absolute top-1/5 left-5 lg:left-1/4 rounded-full h-64 w-[45rem] blur-3xl opacity-70 z-0">
