...
const Job: React.FC<JobProps> = ({
  ...
  return (
    ...
    >
      <MorphingDialogTrigger
        testId="job"
        cursorLabel={`Learn about my time at ${companyName}`}
      ...
      >
        <div className="flex space-x-6 items-center">
          ...
          <div className="flex flex-col w-full">
            ...
            <MorphingDialogSubtitle className="flex justify-between text-darkGrey text-md">
          ...
          <ScrollArea className="h-[90vh]" type="scroll">
            <div className="relative p-6 space-y-6">
              ...
              <div>
                ...
                <MorphingDialogSubtitle className="flex justify-between text-darkGrey dark:text-pillGrey text-md">
                ...
                >
                  <AccordionItem value="skills" className="space-y-3">
                    ...
                    <AccordionContent className="flex flex-wrap gap-3">
                      {skills?.map((skill) => {
                        return <Pill key={`${skill.title}-${skill.id}`} text={skill.title} />
                      })}
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
